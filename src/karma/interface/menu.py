...
class CreditsMenu(Menu):
    def __init__(self) -> None:
        ...
        self.add_text("Nolan : Chef de Projet, sound design, player, manager de ressources et score")
        self.add_text("Paul : Responsable design, musiques, HUD, placements des bâtiments et cycle jour/nuit")
        self.add_text("Gabriel : Responsable technique, conception de l'architecture de code et création des ressources")
        self.add_text("Enzo : Scripts et création d’assets, ennemis, bâtiments et combat")
        self.add_text("Macéo : Maître du temps, map design, système de cinématiques et vidéos")
        self.add_text("Assets : Matt Walkden — Robot Warfare Pack")
        self.add_text("Musiques : Acromusic, GMT, Suka")
